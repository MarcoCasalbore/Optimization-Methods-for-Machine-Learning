# -*- coding: utf-8 -*-
"""
Created on Wed Nov  8 21:35:29 2023

@author: Bianca
"""

from Functions_12_Ghiurca import * 

file = 'Dataset.csv'
(X_train, X_test, Y_train, Y_test) = lettura_file(file)
dataset_train = (X_train, Y_train)
c_in, v_in = var_initialization(seed,N) 
omega_in = omega_initialization(c_in,v_in)
...
plotting(omega_opt, N, sigma, title='ES. 1.2 - RBF') 
